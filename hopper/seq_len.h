...
class SeqLenTraits {
 public:
  ...
  CUTLASS_HOST SeqLenTraits(int sum_s, int max_seq_len, const int* cu_seq_len = nullptr,
                            const int* seq_used = nullptr)
      : sum_s(sum_s),
        cu_seq_len(const_cast<int*>(cu_seq_len)),
        seq_used(const_cast<int*>(seq_used)),

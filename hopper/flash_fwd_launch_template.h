...
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    using Scheduler = std::conditional_t<
        ...
        flash3::SingleTileScheduler,
        std::conditional_t<!Is_causal,
            flash3::StaticPersistentTileScheduler,
            flash3::DynamicPersistentTileScheduler<Kernel_traits::kNThreads - cutlass::NumThreadsPerWarpGroup, Kernel_traits::NumProducerThreads>
    >>;
